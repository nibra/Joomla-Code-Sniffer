<?php
/**
 * Joomla_Sniffs_ControlStructures_SwitchDeclarationSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @version   CVS: $Id: SwitchDeclarationSniff.php 301632 2010-07-28 01:57:56Z squiz $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Joomla_Sniffs_ControlStructures_SwitchDeclarationSniff implements PHP_CodeSniffer_Sniff
{
            ...
            if ($nextBreak !== false && isset($tokens[$nextBreak]['scope_condition']) === true) {
                ...
                if ($tokens[$nextBreak]['scope_condition'] === $nextCase) {
                    if ($tokens[$nextBreak]['column'] !== $caseAlignment+4) {
                        $error = 'BREAK statement must be indented 8 spaces from SWITCH keyword';
        ...
        if ($default !== false) {
            ...
            */
            ...
            if ($nextLine !== ($defaultLine + 1)) {
                ...
                $phpcsFile->addError($error, $default, 'SpacingAfterDefault');
            }
