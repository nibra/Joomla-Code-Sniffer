<?php
/**
 * Parses and verifies the doc comments for files. (Changed slightly from PEAR sniffer)
 *
 * PHP version 5
 *
 * @category  PHP
...
class Joomla_Sniffs_Commenting_FileCommentNamingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected $tags = array(
                       ...
                       'author'     => array(
                                        'required'       => false,
                                        'allow_multiple' => true,
                                        'order_text'     => 'follows @category (if used) @subpackage (if used) or @package',
                                       ),
                       'copyright'  => array(
                                        'required'       => true,
                                        'allow_multiple' => true,
     ...
     *                                                             element.
     *
     * @return integer Length of indentation
     */
