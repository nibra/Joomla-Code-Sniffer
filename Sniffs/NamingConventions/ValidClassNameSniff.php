<?php
/**
 * Joomla_Sniffs_NamingConventions_ValidClassNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * @version   CVS: $Id: ValidClassNameSniff.php 258612 2008-04-28 01:02:28Z squiz $
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Joomla_Sniffs_NamingConventions_ValidClassNameSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('~^([A-Z]|plg)~', $name) == 0) {
            $error = '%s name must begin with a capital letter or "plg"';
